...
function [I_xx, I_yy, I_xy, P_I_uu, P_I_vv, A_O_I, c_g_x, c_g_y, total_area, I_area, I_cg_x, I_cg_y, II_xx, II_yy, II_uu, II_vv, box_area, box_cg_x, box_cg_y, box_xx, box_yy, box_uu, box_vv] = section_properties(filename)
    ...
    [box_area, box_cg_x, box_cg_y, box_xx, box_yy, box_uu, box_vv] = box_section_properties(total_area, x_coordinates, y_coordinates, c_g_x, c_g_y, I_xx, I_yy);
end
...
function [I_area, I_cg_x, I_cg_y, II_xx, II_yy, II_uu, II_vv] = I_section_properties(total_area, x_coordinates, c_g_x, c_g_y, thickness, row, I_xx, I_yy)
    I_area = 2*total_area;
...
function [box_area, box_cg_x, box_cg_y, box_xx, box_yy, box_uu, box_vv] = box_section_properties(total_area, x_coordinates, y_coordinates, c_g_x, c_g_y, I_xx, I_yy)
    box_area = 2*total_area;
    box_cg_x = (max(x_coordinates) + min(x_coordinates))*0.5;
    box_cg_y = (max(y_coordinates) + min(y_coordinates))*0.5;
    box_xx = 2*(I_xx + total_area*(box_cg_y - c_g_y)^2);
    box_yy = 2*(I_yy + total_area*(box_cg_x - c_g_x)^2);
    box_uu = (box_xx + box_yy)*0.5 + sqrt((((box_xx - box_yy)*0.5)^2));
    box_vv = (box_xx + box_yy)*0.5 - sqrt((((box_xx - box_yy)*0.5)^2));
end
